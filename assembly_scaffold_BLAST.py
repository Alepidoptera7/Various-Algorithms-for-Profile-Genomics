...
class tree_maker:
    ...
    def paired_end_assembly(self):
        ...
        for read_header in self.seq_dict_by_head.keys():
            ...
            self.assembled_paired_end_read_dict[read_header] = ''
        ...
        for read_header_r1, read_header_r2 in zip(self.seq_dict_by_head.keys(), self.reverse_complement_dict.keys()):
            print("self.assembled_paired_end_read_dict", self.assembled_paired_end_read_dict)
        ...
        #print(" self.assembled_fourmer_freq_dict: ", self.assembled_fourmer_freq_dict)
    ...
    def fourmer_frequency_of_paired_end_reads(self, analysis_dict):
        ...
        for fourmer in unique_fourmer_list:
            fourmer_freq_dict = fourmer_list.count(fourmer)/256

        print("fourmer freq dict: ", fourmer_freq_dict)
                ...
                if read_head != other_read_head:
                    ...
                    for j in range(8, len(self.seq_dict_by_head[read_head]), 8):
                        ...
                        if seq_1[j:] == seq_2[:len(seq_1[j:])]:
                            ...
                            print("agreement_seq", agreement_seq)
